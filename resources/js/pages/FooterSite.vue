...
// resources/js/components/FooterComplete.vue
</script>
    ...
    <footer  class="bg-gray-50 dark:bg-gray-900 text-gray-600 dark:text-gray-300 mt-14 pt-6 rounded-2xl">
       <section class=" px-4 py-12 sm:px-6 lg:px-8  dark:bg-gray-900">
        <div class="mx-auto max-w-7xl"> 
            ...
            <div class="grid grid-cols-1 md:grid-cols-5 gap-8 mb-12">
               ...
               <!-- <div class="flex h-20 w-20 items-center justify-center rounded-md pt-9 bg-amber-400">
                    ...
                    <p class="leading-relaxed">
                        ...
                        l'informatique en offrant des solutions complètes : création de sites, design impactant et 
                        optimisation digitale, tout en accompagnant l'apprentissage et l'évolution dans un monde 
            ...
            <!-- Ligne de séparation -->
            <div class="border-t border-gray-200 dark:border-green-950 mb-6"></div>

            <!-- Section inférieure -->
            <div class="flex flex-col md:flex-row justify-between">
               <div class="text-sm mb-4 md:mb-0 flex items-center gap-2">
                    © 2025 Devinsto.com. <br class="md:hidden" />
                    ...
                    >H
                         ...
                         <span style="color:#673de6; font-weight:bold; font-family:system-ui, sans-serif;">Hostinger</span>
                    </span>
                </div>
