...
<template>
    ...
    <section class="bg-white px-4 py-12 sm:px-6 lg:px-8 dark:bg-gray-900">
        <div class="mx-auto max-w-7xl">
            <h2 class="mb-8 text-7xl font-bold text-gray-900 dark:text-white">Devinsto
Apprenez, Créez, Collaborez sans limites.</h2>
    ...
    <section class="bg-white px-4 py-12 sm:px-6 lg:px-8 dark:bg-gray-900">
      <div>
        <h4 class="text-7xl">Dernières articles</h4>
        <p class="text-xl">La plateforme ultime pour apprendre, collaborer et construire des projets en développement web, graphisme, et bien plus encore.</p>
      </div>  
